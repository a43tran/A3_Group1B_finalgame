...
**Triangular Laser Indicators:**
After conducting playtesting for our final game, we implemented a triangular laser icon on the player’s screen as a visual signifier to indicate the player’s distance to lasers projected across the walls by the goblins. The lasers have three states, a light yellow as a warning for lasers detected nearby, bright yellow for lasers that are about to fire, and a red for lasers that are firing their beam. During playtesting, we observed that players were confused about where the lasers were coming from and why their social battery bar was taking damage as they walked through the maze pathways. From afar, the darkened scope of their vision did not capture the animated goblins dispatching lasers from the bushes, laboratory cabinets or cafeteria walls. Through this modification, the triangular icons visually inform users of the direction of incoming threats and the colours communicate the urgency of the threat, providing players with sufficient time to anticipate when the lasers will fire and appropriately dodge them to reach the exit without drastically losing social battery health. 
